...
notes: "This table provides review times for L&I plan reviews. This does not reflect total permit review times,
  only L&I-specific review times. Total review times are affected by factors outside of L&I's control. Note that
  review times are delayed on permits with variances, so records where variance = 'Y' show longer review periods."
