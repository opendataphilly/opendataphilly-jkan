...
resources:
  ...
  - description: >
      ...
      population. Free access, no API key required for basic use.
    format: API
    name: ACS 5-Year (2022) - Philadelphia County Level
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B01003_001E&for=county:101&in=state:42
  - description: >
      ...
      variables. Example includes total population.
    format: API
    name: ACS 5-Year (2022) - Census Tract Level
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B01003_001E&for=tract:*&in=state:42&in=county:101
  - description: >
      ...
      parameter to query any ACS variables.
    format: API
    name: ACS 5-Year (2022) - Block Group Level
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B01003_001E&for=block%20group:*&in=state:42&in=county:101&in=tract:*
  - description: >
      Example API query for multiple economic variables: median household
      income, poverty rate, employment status, and median home value by
      census tract.
    format: API
    name: Example - Economic Indicators by Tract
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B19013_001E,B17001_001E,B17001_002E,B23025_003E,B25077_001E&for=tract:*&in=state:42&in=county:101
  - description: >
      ...
      alone, Asian alone, and Hispanic/Latino.
    format: API
    name: Example - Demographics by Tract
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B01003_001E,B03002_003E,B03002_004E,B03002_006E,B03002_012E&for=tract:*&in=state:42&in=county:101
  - description: >
    ...
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B25001_001E,B25002_002E,B25077_001E,B25064_001E,B25003_001E,B25003_002E,B25003_003E&for=tract:*&in=state:42&in=county:101
  - description: >
    ...
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B08301_001E,B08301_002E,B08301_010E,B08301_019E,B08301_021E&for=tract:*&in=state:42&in=county:101
  - description: >
    ...
    url: >
      https://api.census.gov/data/2022/acs/acs5?get=NAME,B15003_001E,B15003_017E,B15003_018E,B15003_022E,B15003_023E&for=tract:*&in=state:42&in=county:101
  - description: >
